...
function getHeaderRow(headerColor: string): Row {
  return {
    rowId: HEADER_ROW_ID,
    height: ROW_HEIGHT,
    cells: [
      nonEditable(emptyTextCell),
      nonEditable(monthHeaderCell("Jan", "justify-content-center", headerColor)), // Pass header color
...
export function getRows(
  ...
  headerColor: string // Accept header color as a parameter
): Row[] {
  return [
